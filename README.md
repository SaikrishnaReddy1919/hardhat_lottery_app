...
[Front Repo for this contract](https://github.com/SaikrishnaReddy1919/Nextjs-lottery-frontend)
...
```
git clone https://github.com/SaikrishnaReddy1919/hardhat_lottery_app.git
cd hardhat_lottery_app
yarn
```
# Usage
...
### In simple testing on testnet(staging tests) needs :
